...
SOFTWARE.
 */
package graves.tim.powermanagement.server.resources.fallback;
...
import graves.tim.powermanagement.common.data.BatteryBasicSettings;
...
@Dependent
@Log
public class BatteryBasicSettingsFallbackHandler implements FallbackHandler<BatteryBasicSettings> {
	...
	private final static List<ExceptionMap> exceptionToCode = Arrays.asList(
			...
			new ExceptionMap(BatteryNotFoundException.class.getName(), Status.NOT_FOUND.getStatusCode()),
			new ExceptionMap(BatteryUnauthorisedAccessException.class.getName(), Status.UNAUTHORIZED.getStatusCode()),
	 ...
	 */
	@Override
	public BatteryBasicSettings handle(ExecutionContext context) {
